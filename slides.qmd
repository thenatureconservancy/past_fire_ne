...
![](images/harry-whitehorse.jpg){.absolute bottom="250" left="0" width="500"}
=======
...
![](images/Muck-a-tak-mish-o-kah-kaik.jpg){.absolute bottom="0" left="450" width="250"}

![](images/Oscar-Howe.jpg){.absolute bottom="250" right="0" width="400"}
:::

::: footer

Harry Whitehorse(Ho-chunk) Oscar Howe(Dakota) George Catlin
=======
